...
"""
修复MLX CFM权重加载问题
直接使用已转换的checkpoints/mlx/s2mel.npz权重
"""
...
def fix_mlx_cfm_weights():
    """修复MLX CFM权重加载问题"""
    
    print("=== 修复MLX CFM权重加载问题 ===")
    ...
    try:
        # 使用MLX的load_weights方法
        mlx_cfm.load_weights(mlx_weights_path)
        print(f"✅ MLX CFM权重加载成功")
